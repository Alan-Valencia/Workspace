...
frase = input("Decirme una frase y te calculo cuanto tardarias si tuvieras que decirla: ")
...
print(f"Dalto lo diria en {cantidad_de_palabras * 100 / 2 // 1.3 / 10} segundos")